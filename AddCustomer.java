...
//    try{
//        Conn conn = new Conn();
//        String query = "Select * form room where availability = 'Available'";
...
//            String query2 = "update room set availability = 'Occupied' wher roomnumber = '"+room+"'";
//            
//            Conn conn = new Conn();
//            
